...
function Calendar(beginYear, endYear, language, patternDelimiter, date2StringPattern, string2DatePattern) {
	...
	this.colors = {"bg_cur_day":"#00CC33","bg_over":"#EFEFEF","bg_out":"#FF0000"}
};
...
document.writeln('<div id="__calendarPanel" style="position:absolute;visibility:hidden;z-index:9999;background-color:#fff;border:1px solid #666;width:200px;height:206px;-webkit-border-radius: 4px;border-radius: 4px; color:#666666">');
...
__ci.document.writeln('th.theader {font-weight:normal;background-color:#999999;color:#FFFFFF;width:24px;}');
...
__ci.document.writeln('input.l {border: 1px solid #CCCCCC;background-color:#EFEFEF;width:20px;height:20px;-webkit-border-radius: 4px;border-radius: 4px; }');
__ci.document.writeln('input.r {border: 1px solid #CCCCCC;background-color:#EFEFEF;width:20px;height:20px;-webkit-border-radius: 4px;border-radius: 4px; }');
__ci.document.writeln('input.b {border: 1px solid #CCCCCC;background-color:#EFEFEF;width:100%;height:20px;-webkit-border-radius: 4px;border-radius: 4px; }');
__ci.document.writeln('-->');
