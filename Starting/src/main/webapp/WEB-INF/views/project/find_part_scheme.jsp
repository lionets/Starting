    ...
    <div class="content-box-content" >
     <table border="0" class="edit-table">
       <tr>
         ...
         <th><label>安装方式:</label></th>
         <td>${pro.setupType }</td>
       </tr>
       <tr>
         <th><label>大臂长度:</label></th>
         <td>${pro.dbcd }</td>
         <th><label>方案高度:</label></th>
         <td>${pro.fagd }</td>
       </tr>
     </table>
     <div style="width:100%">
      <div style="float:left;clear:left;overflow:auto; overflow-x:hidden;height:40%;width: 550px;">
        <p>
      ...
      <div id="tab1" class="tab-content default-tab">
       ...
       <div class="lefttable" style="float:left; margin-left:10px;overflow:auto; overflow-x:hidden; height:40%;width: 550px;">
       <p>
        ...
        <table border="0" class="edit-table">
           <tr>
              <td ><a class="button_new" href="javascript:window.close();" title="返回"><img src="<%=basePath %>static/images/icons/back_icon.png" class="px18"/></a>
              </td>
              <td colspan="3">&nbsp;</td>
            </tr>
          </table>
