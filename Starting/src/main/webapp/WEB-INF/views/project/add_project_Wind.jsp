...
<div id="main-content">
           ...
           <tr >
            ...
            <tr >
             <th><label><b>*</b>项目名称</label></th>
              ...
              <td><input id="proShortName" name="proShortName" required="true"/></td>
 			<th>&nbsp;</th>
            </tr>
            <tr>
            <th>项目高度</th>
 ...
 <th>&nbsp;</th>
          ...
          <tr>
              <td>&nbsp;</td>
              <td colspan="2"><a class="button_new" onclick="window.close()" title="返回"><img src="<%=basePath %>static/images/icons/back_icon.png" class="px18"/></a><a id="submitButton" class="button_new" href="#" title="保存"><img src="<%=basePath %>static/images/icons/save-icon.png" class="px18"/></a>  </td>
            </tr>
          </table>
        </form>
      </div>
