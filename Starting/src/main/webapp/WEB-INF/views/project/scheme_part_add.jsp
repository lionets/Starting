...
function addOne(){
	...
	$(".addOneLevelThree").on("click",function(){
       ...
       var html =  "<tr pid='' partid=''>"+
        ...
        "<td><div align='center'><input   name='Input' onchange='isNum(this);' onkeydown='isNullModelRight(this)' type='text' value='0' class='picture2r'/></div></td>"+
...
$(function(){
	...
	$("#submitButton").on("click",function(){
		...
		for(var i=0; i<data.length; i++){
			...
			one.partBaseId=partmodelid;
			one.partBasePid=partmodelpid;
			one.partNum=num;
			parts[i]=one;
		}
	...
	$(".addOneLevelTow").on("click",function(){
	   ...
	   "<td ><div align='center'><input name='Input' type='text' onchange='isNum(this);' onkeydown='isNullModelLeft(this)' value='0' class='picture2r'></div></td>"+
	   "<td><div align='center'></div></td>"+
	...
	function numOnChange(obj){
		...
		var sum;
		var result;
		var partid = $(obj).parent().prev().find("[partmodelid]").attr("partmodelid");
        ...
        <table  id="mainPartTable">
          ...
          <tbody>
           ...
           <tr pid="${part.pid }" partid="${part.part_model_id }" >
              ...
              <td partNumber="${part.partNumber}"><input  name="partNumber" onchange="numOnChange(this)" type="text" value="${part.partNumber}" class="picture2r"/></td>
 			   		  	...
 			   		  	<c:choose>
						       <c:when test="${partThree.part_model_pid==partTow.part_model_id}">
 						            <tr class="dataTr" pid="${partThree.part_model_pid }" partid="${partThree.part_model_id }" >
							              ...
							              <td partNumber="${partThree.partNumber }"><input name="partNumber" onchange="isNum(this);" type="text" value="${partThree.partNumber }" class="picture2r"/></td>
