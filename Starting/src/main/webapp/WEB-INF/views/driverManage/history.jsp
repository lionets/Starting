...
%>
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">l.dtd">
  ...
  <div class="content-box">
    ...
    <div class="content-box-header">
       ...
       <ul class="content-box-tabs">
        ...
        <li> <a href="#tab2"  class="default-tab"> <h4>历史轨迹</h4></a></li>
         <li> <a href="#tab3"> <h4>信令发送</h4></a></li>
          <li> <a href="#tab4"> <h4>人工定位</h4></a></li>
           <li> <a href="#tab5"> <h4>gps维修</h4></a></li>
      </ul>
      <div class="clear"></div>
      <h3></h3>
    </div>
