...
$(function(){
	$("#submitButton").on("click",function(){
		tatongMethod.confirm("提示","确定要通过吗!",function(r){
				location.href='<%=basePath %>transfer/checked?tab=tab1&id=${id}&tab1PageNum=${tab1PageNum==""?"0":tab1PageNum}' ;
		});
	})
})
      ...
      <div class="tab-content default-tab" id="tab1">
        <form action="" method="post">
          ...
          <table border="0"  class="edit-table">
            <tr>
              <th scope="row">地点</th>
              <td width="300px"><label> ${dispatch.end_address}</label>
              </td>
              <th scope="row">&nbsp;</th>
              <td>&nbsp;</td>
            </tr>
          ...
          <table>
            ...
            <c:forEach items="${dispatchAttachmentList}" var="dispatchAttachment" varStatus="status">
		            <tr>
		              ...
		              <td><div align="center"><img onclick="openImg(this)" width="20px" src="<%=basePath %>static/upload/${dispatchAttachment.attachment_path }" height="20px"/></div></td>
            ...
            <tr>
             ...
             <%--  <a class="button_new" id="submitButton"  href="javascript:void(0)" title="审核"><img src="<%=basePath %>static/images/icons/check_icons.png" class="px18"/></a>--%></td> 
            </tr>
          </table>
        </form>
      </div>
...
function openwin3(){
	...
	window.open('<%=basePath%>transfer/department_view?dispatch_id=${id}&dispatch_type=${dispatch.dispatch_type=="项目"?1:2}'+'&template_id=${dispatch.template_id}'+'&goods_id='+goods_id,'newwindow','height=800,width=1180,top=0,left=100,toolbar=0,menubar=0,scrollbar=yes,resizable=no,location=no,status=no,fullscreen=yes')
}
