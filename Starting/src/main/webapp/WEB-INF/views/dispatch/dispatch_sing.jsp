        ...
        <form action="" method="post">
         ...
         <P><b>调度目的地</b></P>
          <table border="0"  class="edit-table">
            <tr>
              <th scope="row">调度目的地</th>
              <td><input name="Input" type="text" value="上海"  readonly="readonly"/></td>
              <th><label> 调度出发地</label></th>
              <td><input name="Input7" type="text" value="北京" readonly="readonly"/></td>
              <!--调度目的地为项目时显示-->
            </tr>
            <tr>
              <th scope="row">合同编号</th>
              <td><input name="Input6" type="text" readonly="readonly" value="THZM090530-F-001"/></td>
              <th><label><b>*</b>调度时间:</label></th>
