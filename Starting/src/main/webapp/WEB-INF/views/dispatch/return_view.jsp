      ...
      <div class="tab-content default-tab" id="tab1">
        <form action="" method="post">
          <table border="0" class="edit-table">
            <tr>
              <th >归还单号</th>
              <td><input name="Input9" type="text" readonly value="123456"/></td>
          ...
          <table  class="edit-table">
            <tr>
              ...
              <td width="300px;"><input name="Input2" type="text" value="上海四建崇明百联项目"  readonly="readonly"/></td>
              <th >处置形式</th>
          ...
          <table>
             <tr>
              <td scope="row"></td>
              <td><a class="button_new" href="#" onclick="window.close()" title="close"><img src="<%=basePath %>static/images/icons/back_icon.png" class="px18"/></a> </td>
            </tr>
          </table>
        </form>
      </div>
