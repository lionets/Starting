          ...
          <table   class="edit-table">
            <tr>
             <th ><label><b>*</b>发出地:</label></th>
              <td>
                     <select class="easyui-combobox"  name="come_address" id="come_addressbox" disabled="disabled"   style="width:150px;">
						<option value="">${dispatch.start_address }</option>
				</select>
              </td>
              </tr>
          </table>
         ...
         <c:forEach var="part"  items="${part2Detail}" varStatus="status" >
            <tr   pid="${part.part_base_pid }" partid="${part.part_base_id }" >
              <td><div align="center">
               ...
               <td><a href="javascript:showParts(${part.part_base_id})" class="chick_a current1">${part.part_name }</a></td>
              <td>${part.part_model}</td>
              <td>${part.needNum<0?0:part.needNum}</td>
              <td>${part.maxNum==null?0:part.maxNum}</td>
              <td><input name="dispatchNum" partLeft="true" type="text" value="0" class="picture2r"/></td>
					...
					<c:forEach var="partThree"  items="${part3Detail}" varStatus="status" >
			   		  	<c:choose>
						       ...
						       <script>
							            ...
							            <tr  pid="${partThree.part_base_pid }" partid="${partThree.part_base_id }" >
							              <td><div align="center">
							              	<script type="text/javascript">
										          	document.write(num++);
										     </script>
							              ...
							              <td><input name="dispatchNum" type="text" value="0" class="picture2r"/></td>
