...
<SCRIPT type=text/javascript>
	...
	function delTr(obj){
		$.messager.confirm('资产信息', '您确定移除当前资产、零部件信息？', function (yes) {
			if(yes == true){
				removeIsopen(obj);//关闭新建tr，得到确认，要所有新建tr都关闭才能保存
				trNum--;
	...
	function removes(obj){
		$.messager.confirm('资产信息', '您确定删除当前资产、零部件信息？', function (yes) {
			if(yes == true){
				$('#removeId').val($(obj).parent().parent().find('td:eq(0)').children('input').val()+'/');
				$(obj).parent().parent().remove();
			}
		});
	}
  ...
  <div class="content-box">
    ...
    <div class="content-box-content">
      <div class="tab-content default-tab" id="tab1">
        <form id="purchaseForm" action="<%=basePath %>purchase/edit" method="post">
