  ...
  <div class="content-box">
    ...
    <div class="content-box-content">
      <div class="tab-content default-tab" id="tab1">
        <form action="<%=basePath %>maintain/updateCheckList" method="post">
        ...
        <td><input name="checklisst_no" required="true" type="text"  readonly="readonly" value="${checkList.checklisst_no }"/></td>
      ...
      <tr>
        <th scope="row">整改单</th>
        <td><input name="recttification_no" type="radio" value="1"  <c:if test='${checkList.recttification_no ==1 }'>checked="checked"</c:if>/>
          有
