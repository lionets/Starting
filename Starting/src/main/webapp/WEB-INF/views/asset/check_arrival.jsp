  ...
  <div class="content-box">
    ...
    <div class="content-box-header">
      <ul class="content-box-tabs">
      	<c:if test="${type == 1 }">
      	<li><a href="#tab5" class="default-tab chick_a" > <h4>基础资料</h4></a></li>
      	</c:if>
        <!-- href must be unique and match the id of target div -->
        <li> <a href="#tab6" class="<c:if test="${type == 2 }">default-tab</c:if> chick_a"> <h4>部件到货</h4></a></li>
      </ul>
    </div>
    ...
    <div class="content-box-content">
      ...
      <!-- End #tab1 -->
      <div class="tab-content <c:if test="${type == 2 }">default-tab</c:if>" id="tab6">
      <table border="0" class="edit-table">
            <tr>
       ...
       <p>
        ...
        <table >
          ...
          <tbody>
           ...
           <tr pid="${part.part_model_pid }" partid="${part.part_model_id }" >
		        <td><div align="center">     
		          <script type="text/javascript">
              ...
              <td>${part.partNumber - part.receivingAmount}</td>
              <td id="${part.contractPartId }">${part.receivingAmount + part.arrivalNum}</td>
 			   		  	...
 			   		  	<c:choose>
						       <c:when test="${partThree.part_model_pid==partTow.part_model_id}">
 						            <tr class="dataTr" pid="${partThree.part_model_pid }" partid="${partThree.part_model_id }" >
							              ...
							              <td>${partThree.partNumber - partThree.receivingAmount}</td>
							              <td id="${partThree.contractPartId }">${partThree.receivingAmount + partThree.arrivalNum}</td>
