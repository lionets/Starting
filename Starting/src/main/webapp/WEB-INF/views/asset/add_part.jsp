...
function addOne(){
	...
	$(".addOneLevelThree").on("click",function(){
       ...
       var html =  "<tr pid='' partid=''>"+
        ...
        "<td><div align='center' partNumber='0'><input onchange='isNum(this);' onkeydown='isNullModelRight(this)' name='Input' type='text' value='0' class='picture2r'/></div></td>"+
...
$(function(){
	...
	$("#submitButton").on("click",function(){
		...
		for(var i=0; i<data.length; i++){
			...
			if(!isEmpty(partmodelpid) && num == 0){//右侧零部件数量不能为0，左侧未做要求
				tatongMethod.alert("提示","零部件数量不能为0!");
			}
	...
	$(".addOneLevelTow").on("click",function(){
	   ...
	   "<td ><div align='center'><input name='Input' type='text' value='0' onchange='isNum(this);' onkeydown='isNullModelLeft(this)' class='picture2r'></div></td>"+
