  ...
  <div class="content-box">
    ...
    <div class="content-box-content">
      <div class="tab-content default-tab" id="tab1">
        <form action="<%=basePath %>company/department_insert" method="post">
    ...
    <td><input name="department_code" id="department_code" type="text" required="true" value="${department.department_code }"/></td>
  </tr>
