...
<div id="main-content">
  <form id="form" action="updateDuty" method="post">
        ...
        <input type="hidden" name="tab3PerPage" value="${tab3PerPage}">
       	<input type="hidden" name="id" value="${duty.id}">
            ...
            <tr>
              ...
              <td>
 				<select id="homepage" class="easyui-combobox"  name="homepage" >
 					<option value="经理"  <c:if test='${duty.homepage=="经理" }'> selected="selected"</c:if>>经理</option>
 					<option value="项目" <c:if test='${duty.homepage=="项目" }'> selected="selected"</c:if>>项目</option>
 					<option value="调度" <c:if test='${duty.homepage=="调度" }'> selected="selected"</c:if>>调度</option>
 				</select>
                  </td>
              <td>&nbsp;</td>
            </tr>
            <tr>
              ...
              <td>
 				<select id="companyid" class="easyui-combobox" name="companyid">
 					...
 					<option value="${company.id }"   <c:if test='${company.id==duty.companyid }'> selected="selected"</c:if>>${company.shortName }</option>
 					</c:forEach>
 				</select>
                  </td>
              <td>&nbsp;</td>
