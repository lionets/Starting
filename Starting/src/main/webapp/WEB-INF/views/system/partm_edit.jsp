     ...
     <table border="0" class="edit-table">
            <tr>
              <th><label><b>*</b>模块名称：</label></th>
                  <td ><input type="text"  id="templeteName" name="templeteName"  value="${template.template_name }"/>
                     </td>
                  ...
                  <td >
                      <select name="companyid" class="easyui-combobox"   id="companyid" >
					    <c:forEach var="company"  items="${companyList}" varStatus="status" >
							              <option value="${company.id }" <c:if test="${company.id==template.companyId}"> selected="selected"</c:if>>${company.companyShortName }</option>
					   </c:forEach>
					   </select>
                  </td>
             </tr>
              <tr>
    <th scope="row">描述</th>
    <td colspan="5"><textarea name="textarea" name="description" id="description" cols="" rows="">${template.description }</textarea></td>
             </tr>
        ...
        <table  id="mainPartTable">
          ...
          <tbody>
           ...
           <tr pid="${part.pid }" partid="${part.part_model_id }" >
              ...
              <td><div align="center"><input  name="partNumber" type="text" value="${part.partNumber}" class="picture2r"/></div></td>
 			   		  	...
 			   		  	<c:choose>
						       <c:when test="${partThree.part_model_pid==partTow.part_model_id}">
 						            <tr class="dataTr" pid="${partThree.part_model_pid }" partid="${partThree.part_model_id }" >
							              ...
							              <td><div align="center"><input   name="partNumber" type="text" value="${partThree.partNumber }" class="picture2r"/></div></td>
